...
{
    internal class addvoiture:Menu
    {
        public addvoiture():base() {
            Name = nameMenu.addVoiture;
        }
        ...
        {
            Console.WriteLine("nom de la voiture?");
            ...
            new Garage().AjouterVehicule(new Voiture(nom,marque , moteur, 0, 0, 0));
            base.execute();
        }
